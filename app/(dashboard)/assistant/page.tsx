...
const initialMessages: Message[] = [{
  id: "1", role: "assistant",
  content: "Hi Admin!\n\nI'm Kora, your AI assistant. I can help you analyze platform data, manage operations, automate tasks and provide insights.",
  time: "Now",
}];

const suggestions = [
  { icon: Users, text: "Show top partners" },
  { icon: Clock, text: "Check pending approvals" },
  { icon: BarChart2, text: "Show platform insights" },
  { icon: Calendar, text: "Review system activity" },
];

const smartSuggestions = [
  { icon: Calendar, title: "Pending approvals need review.", desc: "Check the admin approval queue.", color: "bg-blue-600/20 text-blue-400" },
  { icon: Users, title: "Partners need follow-up.", desc: "Review partner activity and territories.", color: "bg-emerald-600/20 text-emerald-400" },
  { icon: BarChart2, title: "Platform revenue is trending up.", desc: "View detailed analytics.", color: "bg-teal-600/20 text-teal-400" },
  { icon: Sparkles, title: "Support issues are active.", desc: "Review common tickets.", color: "bg-indigo-600/20 text-indigo-400" },
];

const fallbackConversations: Conversation[] = [
  {
    userMessage: "Show me this month's top partners by revenue.",
    aireplay: "Here's a summary of your top 5 partners by revenue.",
    time: "10:24 AM",
  },
  {
    userMessage: "What's the status of pending approvals?",
    aireplay: "You have pending approvals that need admin review.",
    time: "Yesterday",
  },
  {
    userMessage: "How many new partners joined this month?",
    aireplay: "New partner activity is available in the platform report.",
    time: "May 27",
  },
  {
    userMessage: "Remind me to follow up with inactive partners.",
    aireplay: "I'll remind you to follow up with inactive partners this week.",
    time: "May 26",
  },
];
  ...
  const sendMutation = useMutation({
    ...
    onSuccess: (res) => {
      setMessages(prev => [...prev, {
        ...
        content: res.data?.data?.aireplay || "I've analyzed your platform data. Here are the insights.",
  ...
  return (
    <div>
      <Header
        ...
        subtitle="Your AI assistant for managing and optimizing the KoraAI platform."
      />
              ...
              <CardContent className="p-0">
                <div className="flex min-h-[224px] flex-col gap-5 p-5 sm:flex-row sm:items-center">
                  ...
                  <div className="min-w-0 flex-1">
                    <h2 className="text-2xl font-semibold text-white">Hi Admin!</h2>
                    <p className="mt-3 max-w-xl text-sm leading-6 text-gray-300">
                      I&apos;m Kora, your AI assistant. I can help you analyze platform data,
                      answer questions, automate operations and provide insights.
                    </p>
