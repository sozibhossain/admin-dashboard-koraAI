  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-[16.5%] overflow-hidden rounded-full bg-[#030914] shadow-[inset_0_4px_20px_rgba(0,0,0,0.9)]">
        <div
          className="absolute right-2 top-0 rotate-12 rounded-full bg-blue-500/10 blur-md"
          style={{ height: size * 0.49, width: size * 0.39 }}
        />

        <div className="absolute inset-0 flex items-center justify-center">
          <div
            className="kora-avatar-face flex flex-col items-center"
            style={{ marginTop: size * 0.025, gap: size * 0.062 }}
          >
            <div className="flex" style={{ gap: size * 0.099 }}>
              <span
                className="rounded-full bg-white shadow-[0_0_12px_#ffffff,0_0_20px_rgba(255,255,255,0.6)]"
                style={{ height: size * 0.148, width: size * 0.0864 }}
              />
              <span
                className="rounded-full bg-white shadow-[0_0_12px_#ffffff,0_0_20px_rgba(255,255,255,0.6)]"
                style={{ height: size * 0.148, width: size * 0.0864 }}
